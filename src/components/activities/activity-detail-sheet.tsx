...
import { Download, MapPin, Paperclip, Users, X } from "lucide-react-native";
...
export function ActivityDetailSheet({ activityId, onClose }: Props) {
              ...
              >
                ...
                <View style={{ flexDirection: "row" }}>
                  <View style={{ flex: 1 }}>
                    ...
                    <InfoRow
                      label="Số công văn"
                      value={activity.document_number}
                    />
                  </View>
                  <View style={{ flex: 1 }}>
                    <InfoRow
                ...
                <View>
                  ...
                  {activity.tasks.map((task) => (
                    <TaskCardMobile
                      ...
                      onRefresh={() => fetchDetail(activity.id)}
                    />
                  ))}
                </View>
              )}
