...
export function DqcdScreenHeader({ total }: HeaderProps) {
  return (
    <View style={s.header}>
      ...
      <View>
        <ThemedText style={s.title}>Dân quân cơ động</ThemedText>
...
export function DqcdSearchToolbar({ search, onSearchChange }: ToolbarProps) {
  return (
